...
CameraTagRecorder = function(camera_el) {
  ...
  var buildInterfaceElements = function() {
    ...
    if (check_phone_screen.length == 0) {
      check_phone_screen = $('<div class="cameratag_screen cameratag_check_phone"><div class="cameratag_check_phone_prompt">Check your phone for mobile recording instructions</div><div class="cameratag_check_phone_url">or visit http://'+appServer+'/m/'+video.short_code+' your mobile browser</div></div>');
    }
    // add to DOM
...
CameraTagPlayer = function(video_el) {
  ...
  var init_videojs = function() {
    ...
    player.on("firstplay", function(data) {
    ...
    player.on("loadedalldata", function(data) {
      CameraTag.fire(dom_id, "loadedalldata", data);
    })

    player.on("loadeddata", function(data) {
